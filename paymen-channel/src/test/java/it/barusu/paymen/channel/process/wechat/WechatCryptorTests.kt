...
class WechatCryptorTests {
    companion object {
        @JvmStatic
        private val log = LoggerFactory.getLogger(this::class.java)
    }

    private val cryptor = WechatCryptor()
    ...
    fun testSign() {
        ...
        val signature = cryptor.sign(content, request)

        assertThat(signature).isNotEmpty().contains("B42C02F1B1B6ADF60F4392569CDE446E")
    }
